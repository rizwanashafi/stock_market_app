...
from prophet import Prophet  #model of meta/facebook
...
# Model selection
models = ['SARIMA', 'Random Forest', 'LSTM', 'Prophet', 'GRU', 'ARIMA']
...
if selected_model == 'SARIMA':
    ...
    lstm_model.fit(train_X, train_y, epochs=5, batch_size=16)
